//"use strict";
//define(["cfg", "mock", "maps/maps", "player/player", "menuPlayers/menuPlayers"], function( cfg, mock, Maps, Player, MenuPlayers ) {
...
//        beforeEach(function () {
//
//            maps = new Maps(mock.Game.assets, mock.Game.blockDim, mock.Game.scene, new MenuPlayers());
//
//            player = new Player(0, "testPlayer", spawnPoint, {
//                "speed": 0.45,
//                "shoot": false,
//                "bombs": 2
//            }, true, 0, mock.Game.assets, mock.Game.blockDim);
//        });
//
...
//                ];
//
//                maps.create(mock.Game.blocksTemp);
//
...
//
//                maps.restoreBlock(mock.Game.blocksTemp);
//
//                expect(maps.getBlocks().length).toEqual(135);
//
//            });
...
//
//                var block = new Block(utils.guid(), {x: 0, z: 0}, mock.Game.assets);
//
//                maps.addObject(player);
//
...
//
//                    maps = new Maps(mock.Game.assets, mock.Game.blockDim, mock.Game.scene, new MenuPlayers());
//                    var bombeP1_1 = new Bombe(utils.guid(), player, player.roundPosition(), mock.Game.assets, mock.Game.scene);
//
//                    maps.addObject(player);
...
//
//                    var bombe = new Bombe(utils.guid(), player, player.roundPosition(), mock.Game.assets, mock.Game.scene);
...
//                        "shoot": false,
//                        "bombs": 2
//                    }, true, 0, mock.Game.assets);
//
//
//                    maps.addObject(player2);
//                    var bombe = new Bombe(utils.guid(), player2, player2.roundPosition(), mock.Game.assets, mock.Game.scene);
...
//
//                    maps.addObject(player2);
//                    var bombeP2_1 = new Bombe(utils.guid(), player2, player2.roundPosition(), mock.Game.assets, mock.Game.scene);
//                    player2.addBomb(bombeP2_1);
//
//                    var bombeP1_2 = new Bombe(utils.guid(), player, player.roundPosition(), mock.Game.assets, mock.Game.scene);
//                    player2.addBomb(bombeP1_2);
//
//                    player.position.x = 32;
//                    player2.position.x = 8;
//
//                    var bombeP2_2 = new Bombe(utils.guid(), player2, player2.roundPosition(), mock.Game.assets, mock.Game.scene);
