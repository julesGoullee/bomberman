...
define(function(){
    ...
    BABYLON.ActionManager = function(){
        return {registerAction: function(){}};
    };
    BABYLON.ExecuteCodeAction = function(params, cb){ cb();};
    ...
    var GameMock = {
        ...
        assets : {
            ...
            "tempBlockColision": [{
                clone : function (){
                    return { actionManager: { registerAction: function(){}},dispose : function (){} };
                }
            }],
            "personnage" :[{
                clone : function (){
            ...
            "bombColision" :[{
                actionManager: { registerAction: function(){}},
                clone : function (){
                    return { actionManager: { registerAction: function(){}},dispose : function (){} };
                }
            }],
