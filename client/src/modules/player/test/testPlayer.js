...
define(["player/player", "bomb/bomb", "testConfig/mock", "utils/utils", "config/config"], function(Player, Bombe, mock, utils, cfg){
    describe( "Player", function() {
        ...
        describe( "Bombe", function () {
            ...
            beforeEach( function () {
                bombe = new Bombe( utils.guid(), player, player.roundPosition() , mock.Game.assets, mock.Game.scene);
            });
            ...
            it( "Peut detruire toutes les bombes", function() {
                ...
                var bombe2 = new Bombe( utils.guid(), player, player.roundPosition() , mock.Game.assets, mock.Game.scene);


                player.addBomb( bombe2 );
                var bombe3 = new Bombe( utils.guid(), player, player.roundPosition() , mock.Game.assets, mock.Game.scene);
